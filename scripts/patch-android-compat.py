...
required_markers = [
    'new File(runtimeDir, ".ready-v3")',
    'existsNoFollow(new File(rootfsDir, "bin/sh"))',
...
if missing:
    raise SystemExit("LinuxRuntimeManager is missing required v9 fixes: " + ", ".join(missing))
print("verified LinuxRuntimeManager v9 recovery fixes")
